        ...
        <div className="max-w-md w-full mx-auto relative z-10">
          <div className="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl p-8 text-center border border-white/20 relative overflow-hidden">
            ...
            <div className="relative z-10 mb-8">
              <div className="w-20 h-20 bg-gradient-to-r from-emerald-600 to-green-500 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
            ...
            <div className="relative z-10 space-y-4">
              <p className="text-purple-100 text-sm">
                Click the link in your email to complete your registration and start managing your invoices.
              </p>
              
              <Link 
                href="/auth/login"
                className="inline-block bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold py-3 px-6 rounded-2xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl border-0"
              >
                Back to Login
              </Link>
            </div>
      ...
      <div className="max-w-md w-full mx-auto relative z-10">
        <div className="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl p-8 text-center border border-white/20 relative overflow-hidden">
          ...
          <div className="relative z-10 mb-8">
            ...
            <p className="text-purple-200">
              Join Invoice Manager and start managing your business
            </p>
          </div>
          ...
          {/* Signup Form */}
          <form onSubmit={handleEmailSignup} className="relative z-10 space-y-6">
            <div>
